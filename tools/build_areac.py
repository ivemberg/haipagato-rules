...
# Geometria e macchina a stati stanno in areac_lib, cosi' build_gpx.py verifica i
# percorsi con la stessa identica logica invece di averne una seconda copia.
sys.path.insert(0, str(Path(__file__).resolve().parent))
from areac_lib import (  # noqa: E402
    INNER_BUFFER_M, PROBABLE_MIN_DEPTH_M, PROBABLE_MIN_DWELL_S, STATIONARY_RADIUS_M,
    LAT0, M_LON, M_LAT,
    to_m, dist_point_seg, dist_to_boundary, inside, state, crossing_time, classify_trip,
)
